...
export default function EdtechResources() {
  return (
    <>
      <div className="container">
        <nav className="breadcrumbs"><ol className="breadcrumbs__list">
          ...
          <li className="breadcrumbs__sep">›</li>
          <li className="breadcrumbs__item" aria-current="page">EdTech Resources</li>
        </ol></nav>
      </div>
      <section className="page-section">
        <div className="container">
          <div className="section-heading">
            <h2 className="section-heading__title">EdTech Resources</h2>
            <div className="section-heading__line"></div>
            <p className="section-heading__devanagari">शैक्षिक प्रौद्योगिकी संसाधन</p>
            <p className="section-heading__subtitle">Tools, platforms, and strategies for integrating technology into education effectively.</p>
          </div>
