    ...
    <>
      <div className="container">
        <nav className="breadcrumbs"><ol className="breadcrumbs__list">
          ...
          <li className="breadcrumbs__sep">›</li>
          <li className="breadcrumbs__item" aria-current="page">Teacher Education Resources</li>
        </ol></nav>
      </div>
      <section className="page-section">
        <div className="container">
          <div className="section-heading">
            <h2 className="section-heading__title">Teacher Education Resources</h2>
            <div className="section-heading__line"></div>
            <p className="section-heading__devanagari">शिक्षक शिक्षा संसाधन</p>
            <p className="section-heading__subtitle">Resources for pre-service and in-service teacher education, professional development, and NCTE guidelines.</p>
          </div>
