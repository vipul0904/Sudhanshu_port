...
export default function InternshipDiaries() {
  return (
    <>
      <div className="container">
        <nav className="breadcrumbs"><ol className="breadcrumbs__list">
          ...
          <li className="breadcrumbs__item" aria-current="page">Internship Diaries</li>
        </ol></nav>
      </div>
      ...
      <section className="page-section">
        <div className="container">
          <div className="section-heading">
            <h2 className="section-heading__title">Internship Diaries</h2>
            <div className="section-heading__line"></div>
            <p className="section-heading__devanagari">इंटर्नशिप डायरी</p>
            <p className="section-heading__subtitle">Reflections, observations, and learnings from school internship and teaching practice experiences.</p>
          </div>
